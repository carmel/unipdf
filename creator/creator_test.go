...
import (
	...
	"github.com/carmel/unipdf/contentstream/draw"
	...
	"github.com/carmel/unipdf/internal/testutils"
)
...
func TestImage1(t *testing.T) {
	...
	imgData, err := os.ReadFile(testImageFile1)
	if err != nil {
		t.Errorf("Fail: %v\n", err)
		return
	}
...
func TestOptimizeImageQuality(t *testing.T) {
	...
	imgDataJpeg, err := os.ReadFile(testImageFile1)
	if err != nil {
		t.Errorf("Fail: %v\n", err)
		return
	}
...
func createPdf4Optimization(t *testing.T) *Creator {
	...
	imgData2, err := os.ReadFile(testImageFile1)
	if err != nil {
		t.Errorf("Fail: %v\n", err)
		t.FailNow()
		return nil
...
func testRender(t *testing.T, pdfPath string) {
	...
	tempDir, err := os.MkdirTemp("", "unidoc")
	if err != nil {
		t.Fatalf("Error: %v", err)
	}
